...
> 参考：
>
> - [esp32cam开发板烧录micropython固件报错问题（完美解决） - 哔哩哔哩](https://www.bilibili.com/opus/862757955090513960)
...
上面的方法都无法完美的解决，有时可以有时不行。正确的处理方法如下：

> [V1-02-修复摄像头初始化失败_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1P14y1Y7dE?spm_id_from=333.788.videopod.episodes&vd_source=485a3ba55b82ab1e9f0d8386e3dd8fcc&p=3)

- 根本原因在于摄像头的数据未及时的清理，导致初始化失败。详见视频，每次运行前对摄像头进行==反初始化==即可。
...
> 参考：
>
> - [再谈ESP32_CAM视频传输至公网服务器_esp32cam 视频传输-CSDN博客](https://blog.csdn.net/phoenix3k/article/details/138282996?ops_request_misc=%7B%22request%5Fid%22%3A%2243e01c1b964de5313fd72d464c28ff69%22%2C%22scm%22%3A%2220140713.130102334.pc%5Fall.%22%7D&request_id=43e01c1b964de5313fd72d464c28ff69&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~first_rank_ecpm_v1~rank_v31_ecpm-3-138282996-null-null.142^v102^pc_search_result_base7&utm_term=esp32cam thonny做tcp客户端&spm=1018.2226.3001.4187)
